...
(`reference_parity_vs_system_jq`). **Zero divergences** within the subset.
...
| Date/time builtins (`now`, `strftime`, `gmtime`, `mktime`) | Locale/clock-dependent and non-deterministic; would also break reproducibility. |
